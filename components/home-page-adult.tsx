...
import { Play, Pause, Volume2, Maximize2, BookOpen, GamepadIcon, BarChart3, FolderKanban } from 'lucide-react'
            ...
            <Card className="bg-card border border-border hover:border-primary/50 transition-colors">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">Stock Comparison</h3>
                    <p className="text-muted-foreground mb-4">
                      Compare multiple stocks side by side to analyze performance, metrics, and company details.
                    </p>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      Browse stocks by industry category to discover investment opportunities in different sectors.
                    </p>
                    <Button asChild variant="outline">
                      <Link href="/stocks/categories">Browse Categories</Link>
                    </Button>
                  </div>
                </div>
              </CardContent>
